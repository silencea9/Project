 ...
 ***************************************************************************************************
 * 实验现象
 * 1 本实验需要跳线帽短连接(P10)的ADC和DAC，再使用KEY1/KEY_UP两个按键，控制STM32内部DAC模块的通道1
     输出电压，通过ADC3的通道1采集DAC的输出电压，在LCD模块上面显示ADC获取到的电压值以及DAC的设定
 ...
 * 8 用跳线帽连接P10的ADC和DAC，STM32才能采样到DAC通道的输出电压
